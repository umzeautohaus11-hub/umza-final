...
export default function AuctionVsDealerStock() {
    const fadeInUp = {
            ...
            <section className="py-16 bg-[#0F1614]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-[#BDB6AD] leading-relaxed mb-6">In Japan, auction houses use a strict, unbiased grading system:</p>
                        <ul className="space-y-4 text-[#BDB6AD] mb-8">
                        ...
                        <p className="text-[#BDB6AD] leading-relaxed mb-6">When you import, you see the breakdown:</p>
                        <ul className="space-y-2 text-[#BDB6AD] mb-8">
